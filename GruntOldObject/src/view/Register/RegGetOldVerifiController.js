...
define(['App'], function (app) {
    app.register.controller('RegGetOldVerifiController',
        ['$scope', 'UsersService', '$interval', '$ionicActionSheet', 'VerificationHelp', 'gToast', 'HelpAlterService',function ($scope, UsersService, $interval, $ionicActionSheet, VerificationHelp, gToast, HelpAlterService) {
