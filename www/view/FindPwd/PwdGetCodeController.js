define(['App'], function (app) {
    app.register.controller('PwdGetCodeController',
        ['$scope', 'UsersService', '$cookieStore', '$ionicPopup', 'gToast', 'HelpAlterService', '$state',function ($scope, UsersService, $cookieStore, $ionicPopup, gToast, HelpAlterService, $state) {
            $scope.viewModel = {
                User: {
