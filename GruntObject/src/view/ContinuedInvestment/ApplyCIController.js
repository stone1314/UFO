    ...
    app.register.controller('ApplyCIController',
        ['$scope', '$ionicActionSheet', '$ionicPopup', 'ProductsService', '$stateParams', 'HelpAlterService', 'gToast',function ($scope, $ionicActionSheet, $ionicPopup, ProductsService, $stateParams, HelpAlterService, gToast) {
            ...
            $scope.submit = function () {
                ...
                $scope.pwdModel = HelpAlterService.Confirmation_Pwd($scope, "<div class='text-center fontSize-1-2 fontColor-999999' style='width:100%'>支付金额</div><div class='text-center fontSize-1-2  fontColor-999999' style='width:100%'>（" + $scope.viewModel.totalAmount + "元）</div>");
