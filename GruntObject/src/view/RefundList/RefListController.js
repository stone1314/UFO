define(['App'], function (app) {
    app.register.controller('RefListController',
        ['$scope', 'ProductsService', '$state', 'HelpAlterService', 'UsersService', function ($scope, ProductsService, $state, HelpAlterService, UsersService) {
            ...
            var func = function () {
                UsersService.WeiXinHandleFirstFlag(2);
                HelpAlterService.SetlocalStorage.InvestFlag(1);
            }
                        ...
                        if (data.Result == null) {
                            ...
                            if ($scope.curPage == 1) {
                                ...
                                if (data.Result.length > 0) {
                                    if (HelpAlterService.GetlocalStorage.InvestFlag() == 0) { 
                                        $scope.Popup = HelpAlterService.Alert_prompt($scope, "prompt_refList", func);
                                    }
                                }
