            ...
            UsersService.GetCardBindList().then(function (data) {
                ...
                if (data.Success) {
                    ...
                    angular.forEach($scope.banks, function (data, index, array) {
                        console.log("111111");
                        data.text = "<label class='leftimg'><img src='" + data.BankImgUrl + "' style='width: 35px;vertical-align: bottom;'/></label><label class='rightimg'>" + data.BankName + "</label>"
                        //"<img src='" + data.BankImgUrl + "' style='width: 35px;vertical-align: bottom;'/> " + data.BankName;
                    });
                }  
            });
                ...
                UsersService.BindCard(
                    ...
                    $scope.User.validateCode
                        ...
                        if (!data.Success) {
                            ...
                            HelpAlterService.EndTime($scope, "AddBankCards");
                            gToast.open("银行卡添加成功");
                            history.back(); 
                        } 
                        //console.log(data); 
