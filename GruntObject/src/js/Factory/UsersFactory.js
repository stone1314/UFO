(function(window, angular, undefined) {'use strict';
    angular.module('UsersFactory', ['HttpFactory']).factory("UsersService", ['HttpService', '$stateParams', "gToast", "$cookieStore", '$q', 'VerificationHelp', function (HttpService, $stateParams, gToast, $cookieStore, $q, VerificationHelp) {
        var ServiceUrl = {
            ...
            UpdateIsHideAmountURL: 'Trade/UpdateIsHideAmount',           //显示隐藏金额
            WeiXinHideUserAmountURL: 'Account/WeiXinHideUserAmount',
            HideUserAmountURL: 'Account/HideUserAmount',
            WeiXinHandleFirstFlagURL:'Account/WeiXinHandleFirstFlag'      //用户标识
        }
        ...
        return {
            ...
            Login: function (PhoneNumber, Password) {
                ...
                return HttpService.PostToJson(ServiceUrl.LoginURL, { "Mobile": PhoneNumber, "Password": Password, "OpenID": $cookieStore.get("openID") })
            ...
            SaveUfoUser: function (ufoUser) {
                ...
                ufoUser.OpenID = $cookieStore.get("openID");
            ...
            UpdateIsHideAmount: function (isHide) {
                return HttpService.PostToJson(ServiceUrl.UpdateIsHideAmountURL, { IsHide: isHide });
            },
            WeiXinHideUserAmount: function (isShow) {
                return HttpService.PostToJsonUnLoading(ServiceUrl.WeiXinHideUserAmountURL, { IsShow: isShow });
            },
            HideUserAmount: function (isShow) {
                return HttpService.PostToJsonUnLoading(ServiceUrl.HideUserAmountURL, { IsHide: isShow });
            },
            WeiXinHandleFirstFlag: function (flag) {
                return HttpService.PostToJsonUnLoading(ServiceUrl.WeiXinHandleFirstFlagURL, {
                    Flag: flag
                })
            }
            ////查询单笔理财详情
