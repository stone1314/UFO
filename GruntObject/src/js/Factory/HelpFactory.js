        ...
        function (HttpService, $cookieStore, gToast, $ionicPopup, $interval, VerificationHelp, UsersService, $ionicModal, $sce, $timeout, $rootScope) {
            ...
            return {
                ...
                ImageCode: function (scope, PhoneNumber, resType, SmsFunc, ImageCaptch) {
                    ...
                    scope.ImgCode.imgsrc = $sce.trustAsResourceUrl("data:image/png;base64," + ImageCaptch);
                ...
                Alert_prompt: function ($scope, type, func) {
                    ...
                    $scope.Alert_prompt_Click = function () {
                        func();
                        Popup.close();
                    }
                    return Popup;
                ...
                Alert_Agreement: function ($scope, contextUrl,hasfooter) {
                    ...
                    var alertPopup = $ionicPopup.alert({
                        ...
                        title: '合格投资者认证',
                        okText: "确定",
                        okType: "button-orange-red-alter"
                    });
                ...
                SetlocalStorage: {
                    ...
                    InvestFlag: function (value) {
                        localStorage.setItem("InvestFlag", value)
                    }
                },
                GetlocalStorage: {
                    ...
                    InvestFlag: function () {
                        return localStorage.getItem("InvestFlag");
                    }
                },
