define(["AppFactory"], function (appFactory) {
    appFactory.factory("ProductsService", ['HttpService', '$stateParams', "gToast", "$cookieStore", '$q', 'VerificationHelp', function (HttpService, $stateParams, gToast, $cookieStore, $q, VerificationHelp) {
        var ServiceUrl = {
            ...
            QueryFundProductListURL: 'Product/QueryFundProductList',       //获取私募列表
            QualifiedUserURL: 'Account/QualifiedUser',      //合格投资者认证
            QueryFundProductDetailURL: 'Product/QueryFundProductDetail',        //私募详情
            PreOrderURL: 'Trade/PreOrder',          //预约私募产品
            QueryOrderRecordListURL: 'Trade/QueryOrderRecordList',        //查询私募预约列表
            ConfirmPurchasingURL: "Trade/ConfirmPurchasing",          //购买前确认信息(查询梵高收益)
        }
        ...
        return {
            ...
            ///*  获取私募列表
            ///*
            QueryFundProductList: function (currentPage, pgeSize) {
                return HttpService.PostToJsonUnLoading(ServiceUrl.QueryFundProductListURL, {
                    PageIndex: currentPage, PageSize: pgeSize
                });
            },
            ///*
            ///*  合格投资者认证
            ///* 
            QualifiedUser: function () {
                return HttpService.PostToJson(ServiceUrl.QualifiedUserURL, null);
            },
            ///*
            ///*  私募基金详情
            ///* 
            QueryFundProductDetail: function (productId) {
                return HttpService.PostToJson(ServiceUrl.QueryFundProductDetailURL, { ProductId: productId });
            },
            ///
            ///   预约私募产品
            ///
            PreOrder: function (password, productId) {
                return HttpService.PostToJson(ServiceUrl.PreOrderURL, { ProductId: productId, Password: password });
            },
            ///
            ///   查询私募预约列表
            ///
            QueryOrderRecordList: function () {
                return HttpService.PostToJsonUnLoading(ServiceUrl.QueryOrderRecordListURL, null);
            },
            ///
            ///
            ///
            ConfirmPurchasing: function (productId, amount) { 
                return HttpService.PostToJson(ServiceUrl.ConfirmPurchasingURL, { ProductId:productId,Amount: amount });
            }
        }
    }]);
